...
function multiple_business_scripts(){
	...
	multiple_business_enqueue( apply_filters( 'bgp_scripts_styles', $scripts ) );
...
* @return array
*/
function multiple_business_ocdi_import_files() {
	return array(
		array(
		  'import_file_name'             => esc_html__( 'Theme Demo Content', 'multiple-business' ),
		  'categories'                   => array( 'Category 1', 'Category 2' ),
		  'local_import_file'            => trailingslashit( get_template_directory() ) . 'ocdi/multiple-business.xml',
		  'local_import_widget_file'     => trailingslashit( get_template_directory() ) . 'ocdi/multiple-business.wie',
		  'local_import_customizer_file' => trailingslashit( get_template_directory() ) . 'ocdi/multiple-business.dat',
		  'import_preview_image_url'     => trailingslashit( get_template_directory() ) . 'screenshot.png',
		  'import_notice'                => __( 'Please waiting for a few minutes, do not close the window or refresh the page until the data is imported.', 'multiple-business' ),
		  'preview_url'                  => 'https://www.demo.keonthemes.com/multiple-business',
		),
	);
}
add_filter( 'pt-ocdi/import_files', 'multiple_business_ocdi_import_files' );
