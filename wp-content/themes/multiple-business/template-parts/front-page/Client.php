...
<?php 
if( !multiple_business_get_option( 'disable_client' ) ):

	$client_ids = multiple_business_get_ids( 'client_page' );
	if( !empty( $client_ids ) && is_array( $client_ids ) && count( $client_ids ) > 0 ):
		...
		<section class="wrapper block-team">
			<div class="container">
				<div class="section-title-group">
					<h2 class="section-title"><?php echo wp_kses_post( multiple_business_get_option( 'client_section_title' ) ); ?></h2>
				</div>
